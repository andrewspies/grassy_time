...
import { TextField, ButtonGroup, Button, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText } from '@mui/material';
import './style.css';
...
const Signup: React.FC<Props> = (props: Props) => {
  ...
  const handleLogin = (event: FormEvent<HTMLFormElement>) => {
    ...
    createUserWithEmailAndPassword(auth, email, password)
      ...
      .catch((error) => {
        setError(`Unable to Register. See full error below:\n\n${error}`);
        toggleOverlay();
      ...
      <div className="form-container">
        <form onSubmit={handleLogin}>
          ...
          <ButtonGroup variant="contained">
            <Button type="submit" color="primary">{props.signUpBtnLabel}</Button>
          </ButtonGroup>
        </form>
        <Link className="login-link" to="/Login" color="secondary">{props.loginBtnLabel}</Link>
